...
contextBridge.exposeInMainWorld("figaf", {
  ...
  faid: {
    ...
    services:           (a) => ipcRenderer.invoke("faid:services", a || {}),
    databaseStatus:     ()  => ipcRenderer.invoke("faid:databaseStatus"),
    databasePrepare:    (a) => ipcRenderer.invoke("faid:databasePrepare", a || {}),
    databaseRotate:     ()  => ipcRenderer.invoke("faid:databaseRotate"),
    databaseDrop:       (a) => ipcRenderer.invoke("faid:databaseDrop", a || {}),
